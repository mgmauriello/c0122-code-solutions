...
function renderPokemon(pokemon) {
  var pokeColumn = document.createElement('div');
  pokeColumn.className = 'column-third';

  var pokemonCard = document.createElement('div');
  pokemonCard.className = 'pokemon-card';
  pokeColumn.appendChild(pokemonCard);
  ...
  secondHeading.appendChild(pokemonName);
  pokemonCardText.appendChild(secondHeading);

  var thirdHeading = document.createElement('h3');
  var pokemonNum = document.createTextNode(pokemon.number);
  thirdHeading.appendChild(pokemonNum);
  pokemonCardText.appendChild(thirdHeading);

  var paragraph = document.createElement('p');
  var pokeDescription = document.createTextNode(pokemon.description);
  paragraph.appendChild(pokeDescription);
